...
- **3/8**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) and delete this comment -->
...
1. Renamed the enhanced interface to `CounterInterface` for clarity.
2. Included the `Standard` interface to maintain consistency and best practices.
3. Ensured `CounterInterface` inherits from `CounterKernel` for clear separation of core and additional functionality.
